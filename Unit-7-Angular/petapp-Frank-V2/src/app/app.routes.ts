...
import { PetDisplay } from './components/pet-display/pet-display'; //Defined as import here
...
export const routes: Routes = [
    ...
    {path: 'petdisplay',     component:PetDisplay} //import name is used afet component
];
